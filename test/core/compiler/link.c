...
static const link_test_t tests [] = {
  ...
  },
  {
    ...
    .host = HOST_X64_WINDOWS,
    .link_args = { "/B" },
    .profile = { .arch = SPN_ARCH_X64, .os = SPN_OS_WINDOWS, .abi = SPN_ABI_MSVC, .runtime = SPN_RUNTIME_STATIC },
    .kind = SPN_CC_OUTPUT_EXE,
    .arg = "/A",
    .expect = {
      .command = "cc",
  ...
  },
  {
    ...
    .expect = {
      .command = "cc",
      .args = { "--target=x86_64-windows-msvc", "-fms-runtime-lib=static", "main.o", "-o", "main" },
    },
  },
  {
    .name = "clang_msvc_shared_runtime",
    .driver = SPN_CC_DRIVER_CLANG,
    .host = HOST_X64_WINDOWS,
    .profile = { .arch = SPN_ARCH_X64, .os = SPN_OS_WINDOWS, .abi = SPN_ABI_MSVC, .runtime = SPN_RUNTIME_SHARED },
    .kind = SPN_CC_OUTPUT_EXE,
    .expect = {
      .command = "cc",
      .args = { "--target=x86_64-windows-msvc", "-fms-runtime-lib=dll", "main.o", "-o", "main" },
    },
  },
  {
  ...
  },
  {
    ...
    .expect = {
      .command = "cc",
      .args = { "--target=x86_64-windows-msvc", "-fms-runtime-lib=static", "-Wl,/SUBSYSTEM:WINDOWS", "-Wl,/ENTRY:mainCRTStartup", "main.o", "-o", "main" },
    },
  },
  {
  ...
  },
  {
    ...
    .expect = {
      .command = "cc",
      .args = { "--target=x86_64-windows-msvc", "-fuse-ld=lld", "-fms-runtime-lib=static", "main.o", "-o", "main" },
    },
  },
  {
    ...
    .link_args = { "-fuse-ld=lld" },
    .host = HOST_X64_LINUX,
    .profile = { .arch = SPN_ARCH_X64, .os = SPN_OS_WINDOWS, .abi = SPN_ABI_MSVC, .sdk = "/X", .runtime = SPN_RUNTIME_STATIC },
    .kind = SPN_CC_OUTPUT_EXE,
    .system_lib = "user32",
    .expect = {
      .command = "cc",
      .args = { "--target=x86_64-windows-msvc", "-fuse-ld=lld", "-fms-runtime-lib=static", "main.o", "-luser32", "-o", "main" },
  ...
  },
  {
    ...
    .driver = SPN_CC_DRIVER_ZIG,
    .host = HOST_X64_LINUX,
    .profile = { .arch = SPN_ARCH_X64, .os = SPN_OS_WINDOWS, .abi = SPN_ABI_MSVC, .runtime = SPN_RUNTIME_STATIC, .sdk = "/X", .libc = "/L" },
    .kind = SPN_CC_OUTPUT_EXE,
    .system_lib = "user32",
    .expect = {
      .command = "cc",
  ...
  },
  {
    ...
    .driver = SPN_CC_DRIVER_MSVC,
    .host = HOST_X64_WINDOWS,
    .profile = { .arch = SPN_ARCH_X64, .os = SPN_OS_WINDOWS, .abi = SPN_ABI_MSVC, .runtime = SPN_RUNTIME_STATIC, .sdk = "/X" },
    .kind = SPN_CC_OUTPUT_EXE,
    .system_lib = "user32",
    .expect = {
      .command = "cc",
